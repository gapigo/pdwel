...
<section class="cms__container main-wrapper">
    ...
    <section class="cms__container__content">
        ...
        <div class="split__container">
            ...
            <!-- Conteudo do produto -->
            <h2 class="title-small">Editar produto</h2>
            <p>Ultilize os campos abaixo para fazer alterações no produto</p>
            ...
            <textarea id="product-description" cols="30" rows="auto" required tabindex="2" placeholder="Ex: Cur cobaltum...">Cur cobaltum congregabo? Ubi est azureus demissio? Ecce, talis terror! Nunquam examinare demolitione. Ubi est secundus devirginato? Clabulares credere in quadrata! Ubi est rusticus devirginato? Cur musa messis? Ire absolute ducunt ad barbatus castor. Festus, noster ignigenas sensim resuscitabo de nobilis, barbatus byssus.</textarea>
    ...
    <footer class="cms__container__footer flex-container">
        <div>
            <a href="javascript:;" class="button button_primary" role="button">Salvar alterações</a>
            <a href="cms-home.php" class="button button_secondary" role="button">Cancelar</a>
        </div>
        <div>
            <a href="javascript:;" class="footer__delete" role="button">Excluir Produto</a>
        </div>
    </footer>
</section>
@endsection